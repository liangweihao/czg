...
public class MyInteractionNoticeMyFragmentAdapter extends RecyclerView.Adapter<MyInteractionNoticeMyFragmentAdapter.MyViewHolder> {

    private Context context;
    private List<String> list;

    public MyInteractionNoticeMyFragmentAdapter(FragmentActivity activity, List<String> mDatas) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        //头像
        Glide.with(context).load("http://7xi8d6.com1.z0.glb.clouddn.com/20171219115747_tH0TN5_Screenshot.jpeg").asBitmap().into(holder.ivMyInteractionNoticeMyItemHead);

        Glide.with(context).load("http://pics.sc.chinaz.com/files/pic/pic9/201306/xpic11726.jpg").asBitmap().into(holder.ivMyInteractionNoticeMyItemPic);
    }
