...
public class MyCollectDataLibraryItemRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyCollectDataLibraryItemRecyclerAdapter(FragmentActivity activity, List<CollectList.ResponseParamsBean.DataBaseListBean> list, int type) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        final CollectList.ResponseParamsBean.DataBaseListBean dataBean = list.get(position);
        if (holder instanceof Item1ViewHolder) {
            ...
            ((Item1ViewHolder) holder).itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("collect" , select) ;
