...
/**
 * Created by Caizhiguang on 2018/5/15.
 */
        ...
        if (mTextView != null) {
            if (usable) {
                ...
                if (!mTextView.isClickable()) {
                    ...
                    mTextView.setBackgroundResource(R.drawable.shape_register_send_code_bg);
                ...
                mTextView.setBackgroundResource(R.drawable.shape_cutdown_bg);
                mTextView.setPadding(50 , 10 , 50 , 10);
